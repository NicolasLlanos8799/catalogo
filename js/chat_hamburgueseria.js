    ...
    function initChat() {
        ...
        function addMessage(text, from = "bot", opts = {}) {
            ...
            lines.forEach((line, index) => {
                ...
                // Check if this line is the Catalog Trigger
                if (from === "bot" && (cleanLine === "👉 Ver catálogo" || cleanLine === "Ver catálogo")) {
                    const btn = document.createElement("button");
                    btn.className = "primary-btn";
                    btn.textContent = cleanLine; // Keep original text
                    ...
                    btn.onclick = window.openCatalog;
        ...
        function openCatalogModal() {
            ...
            // Set src only when opening to ensure fresh load/state if desired, or keep it loaded.
            if (!catalogFrame.getAttribute("src")) {
                catalogFrame.src = "catalogo.html";
            }
